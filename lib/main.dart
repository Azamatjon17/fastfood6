...
import 'package:fastfood6/fourthpage.dart';
...
class _MainBody extends State<MainBody> {
  ...
  @override
  void initState() {
    pages = [Firstpage(), Secondpage(), Thirdpage(), Fourthpage(changepage)];
  }
      ...
      body: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              height: 60,
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), boxShadow: [BoxShadow(blurRadius: 5, spreadRadius: 4, color: Colors.grey.shade200)], color: Colors.white),
              child: Row(
